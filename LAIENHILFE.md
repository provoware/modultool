...
- **Hilfe als PDF speichern**
  ```bash
  bash tools/offline_help.sh
  ```
  *(Erstellt `assets/laienhilfe.pdf` mit pandoc.)*
- **Module-Fehlermeldungen prüfen**
  ```bash
  node core/module_loader.js
  ```
  *(Zeigt Warnungen, falls Moduldateien fehlen.)*
